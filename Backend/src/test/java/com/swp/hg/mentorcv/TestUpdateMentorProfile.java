...
//    @Test
//    public void testUpdateMentorCV_InvalidYearsOfExp() {
//        // Arrange
//        int userID = -1;
//        MentorCVDTO mentorCVDTO = createMockMentorCVDTO();
//
...
//
//        // Set an invalid input for yearsOfExp
...
//        assertEquals("Invalid input", ((ApiResponse) response.getBody()).getMessage());
//        List<String> expectedErrors = Collections.singletonList("Invalid value for yearsOfExp");
//        assertEquals(expectedErrors, ((ApiResponse) response.getBody()).getErrors());
//
//        // Verify the method invocations
//        verify(mentorProfileRepo).findMentorProfilesByUserID(userID);
//        verify(userRepository).findById(userID);
//        verify(mentorProfileRepo, never()).save(mentorProfile);
